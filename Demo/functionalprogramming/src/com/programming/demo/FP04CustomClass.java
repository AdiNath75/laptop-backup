...
class Course {
	...
	public String toString() {
		return "Name=" + name + " ReviewScore=" + reviewScore + ", noOfStudents=" + noOfStudents;
	}
}
...
public class FP04CustomClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				courses.stream().filter(reviewScoreGreaterThan95Predicate).mapToInt(Course::getNoOfStudents).sum());
		// 88000
